    ...
    def createMeeting(self, summary, start_time, end_time, users):
        ...
        for email in users:
            ...
            for mid, mst in self.users_meeting[email]:
                ...
                if (
                        meeting.start_time <= start_time <= meeting.end_time):  # and (meeting.start_time <= end_time <= meeting.end_time):
        ...
        if users:
            for email in users:
                for index, value in enumerate(self.users_meeting[email]):
                    ...
                    if (user_meeting.id != meeting.id) and (
                            user_meeting.start_time <= start_time <= user_meeting.end_time):  # and (meeting.start_time <= end_time <= meeting.end_time):
                        print("Meeting overlap")
                        return
...
if __name__ == "__main__":
    ...
    ms.createMeeting("Team meetup", "Apr 10 2024 10:30 AM", "Apr 10 2024 11:00 AM",
                     ["Kiran@gmail.com", "Ravi@gmail.com"])
    meeting = ms.createMeeting("General Discussion", "Apr 11 2024 11:30 AM", "Apr 11 2024 11:30 AM",
                               ["Sneha@gmail.com", "Kiran@gmail.com"])
    ms.updateMeeting(meeting.id, "General Discussion", "Apr 13 2024 5:00 PM", "Apr 13 2024 5:30 PM",
                     ["Sneha@gmail.com", "Kiran@gmail.com"])
